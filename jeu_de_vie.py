...
class Grille:
    ...
    def compute_next_iteration(self):
        ...
        voisins = (
            np.roll(self.cells, 1, axis=0) +  # Haut
            np.roll(self.cells, -1, axis=0) + # Bas
            np.roll(self.cells, 1, axis=1) +  # Gauche
            np.roll(self.cells, -1, axis=1) + # Droite
            np.roll(np.roll(self.cells, 1, axis=0), 1, axis=1) + # Diagonale haut-gauche
            np.roll(np.roll(self.cells, 1, axis=0), -1, axis=1) + # Diagonale haut-droite
            np.roll(np.roll(self.cells, -1, axis=0), 1, axis=1) + # Diagonale bas-gauche
            np.roll(np.roll(self.cells, -1, axis=0), -1, axis=1)  # Diagonale bas-droite
        )
...
if __name__ == '__main__':
    ...
    dico_patterns = {
        ...
        "c": ((17, 17), [(2, 4), (2, 5), (2, 6), (7, 4), (7, 5), (7, 6), (9, 4), (9, 5), (9, 6), (14, 4), (14, 5), (14, 6), (2, 10), (2, 11), (2, 12), (7, 10), (7, 11), (7, 12), (9, 10), (9, 11), (9, 12), (14, 10), (14, 11), (14, 12), (4, 2), (5, 2), (6, 2), (4, 7), (5, 7), (6, 7), (4, 9), (5, 9), (6, 9), (4, 14), (5, 14), (6, 14), (10, 2), (11, 2), (12, 2), (10, 7), (11, 7), (12, 7), (10, 9), (11, 9), (12, 9), (10, 14), (11, 14), (12, 14)]),
